...
function adtest_allexecute(executeobject, callback) 
{
    ...
    async.series(
    [   
    //function (cb1) {ettss3({}, function (err, res) {cb1(null, res)})},
    //function (cb1) {ettestt1s({}, function (err, res) {cb1(null, res)})},
    //function (cb1) {ettest_recurseModObj({"setup":false}, function (err, res) {cb1(null, res)})},
	//function (cb1) {pu1({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {filterobjecttest1({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {filterobjecttest2({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {filterobjecttest3({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {testhtmladd({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {testcache1({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {testcache2({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore1({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore2({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore3({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore4({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastorefunction({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore5({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore6({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore7({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore8({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore9({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore10({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore11({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore12({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore13({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore14({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastore15({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastoreaddget1({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {datastoreaddget2({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {filterobjecttest1({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {getcollectionlengthtest1({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {getcollectionlength({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {deletecollectiontest1({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {deletecollection({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {processeventtest1({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {ux({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {filterobjecttest1({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {filterobjecttest2({}, function (err, res) {cb1(null, res)})}
	//function (cb1) {filterobjecttest3({}, function (err, res) {cb1(null, res)})}
	function (cb1) {adtest_testprocessqueue1({}, function (err, res) {cb1(null, res)})}
    ],
    function (err, res) {
...
function adtest_testsavetoqueue1 (params, callback) {
	...
	savetoqueue({
					...
					proxyprinttodiv('save first record err --', err, 99);
					proxyprinttodiv('save first record res --', res, 99);
...
exports.adtest_testprocessqueue1 = 
adtest_testprocessqueue1 = 
widtests.adtest_testprocessqueue1 = 
function adtest_testprocessqueue1 (params, callback) {
	
	var expres = {"a":"1","b":"2","wid":"wid1","metadata":{"method":"defaultdto","date":{'exception':['changed','deleted','created']}}};
	
	adtest_testsavetoqueue1(null, function (err, res) {
		
		processqueue('eventonemin', function (err, res) {
			proxyprinttodiv('adtest_testprocessqueue1 err --', err, 99);
			proxyprinttodiv('adtest_testprocessqueue1 res --', res, 99);
			
			execute({
					"executethis": "getwidmaster",
					"wid": "wid1"
					}, function (err, res) {
						proxyprinttodiv('get result for wid3 --', res, 99);
						var result = logverify('adtest_testprocessqueue1', res, expres);
						callback(err, result);
					});
		});
	});
}
widtests.adtest_testprocessqueue1.category = "redaily";
widtests.adtest_testprocessqueue1.subcategory = "push";
widtests.adtest_testprocessqueue1.js = exports.adtest_testprocessqueue1;
widtests.adtest_testprocessqueue1.description = "This tests that both savetoqueue and processqueue are working";
