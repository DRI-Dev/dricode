...
exports.save1test = save1test = function save1test(p, callback) {
    var testparameters = {
        "command" : {
            "queuename": "symphony"
        },
    ...
    savetoqueue(testparameters, callback);
};
...
exports.getfromqueue = getfromqueue = function getfromqueue(inputobj, callback) {
    ...
    // var wid = inputobj["wid"];
    var executeobject = {};
    executeobject["executethis"] = "getwidmaster"; // "querywid";
    executeobject["command"] = {
        "result": "queryresult"
    };
    executeobject["mongorawquery"] = {
