...
(function (window) {
                            ...
                            "command": {
                                ...
                                "postexecute":
                                    ...
                                    "onfail": 
                                        ...
                                        "parameters": {},
                                        "waterfall": true, // results of first call as input to second one
                                        "finalresult": "execute" // "postexecute"
                                        },
                                    },
                        }, {
                            "command": {
    ...
    //                            resultparameters.command.environment.run.executeid = incomingparams.command.environment.run.executeid;
                                ...
                                if (err && Object.keys(err).length > 0)
                                {
                                    ...
                                    {
                                        postexecute(resultparameters, command, "onfail", callback)
                                    }
                                    else
                                    {
                                ...
                                else
                                {
                                    ...
                                    {
                                        postexecute(resultparameters, command, "onsucess", callback)
                                    }
                                    else
                                    {
    ...
    function postexecute(resultparameters, command, status, callback)
    {
        var executeobject = {};
        if (command.postexecute[status].waterfall) {extend(true, executeobject, resultparameters)}
        extend(true, executeobject, command.postexecute[status].parameters);
        executeobject.executethis = command.postexecute[status].executethis;

        if (command.postexecute[status].executemethod==="synchronous")
        {
